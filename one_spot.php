		...
		<div class="main">
			...
			<div class="container spots_container">
				...
				<section class="spot_section">
					...
					<div class="btn_main">
					<a href="add_spot.php" class="btn_add"> <b>Внести изменения</b></a>
					</div>
				  </section>
			  <hr class="hr1" />
			  <div class="info">
					  ...
					  <p class="leftstr">Тип</p>
					  <p class="rightstr"><?php echo $spots["type"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Сложность</p>
					  <p class="rightstr"><?php echo $spots["complexity"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Направление ветра</p>
					  <p class="rightstr"><?php echo $spots["direction_wind"] ?></p>
					  <div style="clear: left"></div>
					  <p id="direction_svell" class="leftstr">Направление свелла</p>
					  <p id="direction_svell_right" class="rightstr"><?php echo $spots["direction_svell"] ?></p>
					  <script>
							if("<?php echo $spots["direction_svell"] ?>" == ""){
								document.getElementById("direction_svell").style.display = "none";
								document.getElementById("direction_svell_right").style.display = "none";
							}
						</script>
					  <div style="clear: left"></div>
					  <p class="leftstr">Направление волны</p>
					  <p class="rightstr"><?php echo $spots["direction_wave"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Дно</p>
					  <p class="rightstr"><?php echo $spots["bottom"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Лучший сезон</p>
					  <p class="rightstr"><?php echo $spots["best_season"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Подъезд к берегу</p>
					  <p class="rightstr"><?php echo $spots["entrance_coast"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Опасности</p>
					  <p class="rightstr"><?php echo $spots["danger"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Инфраструктура</p>
					  <p class="rightstr"><?php echo $spots["infrastructure"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Расстояние</p>
					  <p class="rightstr"><?php echo $spots["distance"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Легко найти?</p>
					  <p class="rightstr"><?php echo $spots["easy_to_find"] ?></p>
					  <div style="clear: left"></div>
					  <p class="leftstr">Дополнительная <br> информация:</p>
					  <p class="rightstr"><?php echo $spots["add_information"] ?></p>
					  <div style="clear: left"></div>
					</div>
